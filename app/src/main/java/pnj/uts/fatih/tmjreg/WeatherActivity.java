        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(search.getText().toString().length() > 0) {
                    ...
                    Toast.makeText(WeatherActivity.this, "Mohon Isi Data yang Diperlukan", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        try {
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(@NotNull Call call, @NotNull IOException e) {
                    Toast.makeText(WeatherActivity.this, "Terjadi Eror", Toast.LENGTH_SHORT).show();
                }
